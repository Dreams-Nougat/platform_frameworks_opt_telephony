...
public class SimActivationTrackerTest extends TelephonyTest {
    ...
    public void testSetVoiceActivationState() {
        ...
        assertTrue(mSAT.setVoiceActivationState(SIM_ACTIVATION_STATE_ACTIVATED));
        ...
        assertFalse(mSAT.setVoiceActivationState(SIM_ACTIVATION_STATE_RESTRICTED));
        assertEquals(SIM_ACTIVATION_STATE_ACTIVATED, mSAT.getVoiceActivationState());
    ...
    public void testSetDataActivationState() {
        ...
        assertTrue(mSAT.setDataActivationState(SIM_ACTIVATION_STATE_DEACTIVATED));
        ...
        assertTrue(mSAT.setDataActivationState(SIM_ACTIVATION_STATE_RESTRICTED));
