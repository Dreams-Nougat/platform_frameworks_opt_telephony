...
public class TelephonyRegistryMock extends ITelephonyRegistry.Stub {
    ...
    @Override
    public void notifyVoiceActivationStateChangedForPhoneId(int phoneId, int subId, String state) {
        throw new RuntimeException("Not implemented");
    }

    @Override
    public void notifyDataActivationStateChangedForPhoneId(int phoneId, int subId, String state) {
        throw new RuntimeException("Not implemented");
    }
}
