...
public class MSimSmsManager {
    ...
    public void sendTextMessage(
        ...
        try {
            ...
            if (iccISms != null) {
                iccISms.sendTextOnSubscription(ActivityThread.currentPackageName(), destinationAddress,
    ...
    public void sendTextMessageWithPriority(
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                iccISms.sendTextWithPriorityOnSubscription(destinationAddress, scAddress, text, sentIntent,
    ...
    public void sendMultipartTextMessage(String destinationAddress, String scAddress,
        ...
        if (parts.size() > 1) {
            try {
                ...
                if (iccISms != null) {
                    iccISms.sendMultipartTextOnSubscription(ActivityThread.currentPackageName(),
    ...
    public void sendDataMessage(
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                iccISms.sendDataOnSubscription(ActivityThread.currentPackageName(), destinationAddress,
    ...
    public boolean copyMessageToIcc(byte[] smsc, byte[] pdu, int status,
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                success = iccISms.copyMessageToIccEfOnSubscription(ActivityThread.currentPackageName(), status,
    ...
    deleteMessageFromIcc(int messageIndex, int subscription) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                success = iccISms.updateMessageOnIccEfOnSubscription(ActivityThread.currentPackageName(),
   ...
   /**
    ...
    public ArrayList<SmsMessage> getAllMessagesFromIcc(int subscription) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                records = iccISms.getAllMessagesFromIccEfOnSubscription(ActivityThread.currentPackageName(),
                       subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
    ...
    public boolean enableCellBroadcast(int messageIdentifier, int subscription) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                success = iccISms.enableCellBroadcastOnSubscription(messageIdentifier,
                                  subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
    ...
    public boolean disableCellBroadcast(int messageIdentifier, int subscription) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                success = iccISms.disableCellBroadcastOnSubscription(messageIdentifier,
                                  subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
    ...
    public boolean enableCellBroadcastRange(int startMessageId, int endMessageId,
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                success = iccISms.enableCellBroadcastRangeOnSubscription(startMessageId,
    ...
    public boolean disableCellBroadcastRange(int startMessageId, int endMessageId,
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                success = iccISms.disableCellBroadcastRangeOnSubscription(startMessageId,
                                  endMessageId, subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
    ...
    boolean isImsSmsSupported(int subscription) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                boSupported = iccISms.isImsSmsSupportedOnSubscription(subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
        }
    ...
    String getImsSmsFormat(int subscription) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("isms"));
            if (iccISms != null) {
                format = iccISms.getImsSmsFormatOnSubscription(subscription);
            }
        } catch (RemoteException ex) {
            // ignore it
        }
