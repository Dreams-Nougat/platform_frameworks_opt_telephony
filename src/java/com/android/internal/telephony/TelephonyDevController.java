...
public class TelephonyDevController extends Handler {
   static final String LOG_TAG = "TelephonyDevController";
   static final boolean DBG = true;
   static final boolean DBG_DATA = true;
    ...
    */
   static final int DEV_MODEM_STATE_ENABLED  = 0;
   static final int DEV_MODEM_STATE_DISABLED = 1;
    ...
    */
   static final int DEV_MODEM_RIL_MODEL_SINGLE   = 0;
   static final int DEV_MODEM_RIL_MODEL_MULTIPLE = 1;
    ...
    */
   static final int DEV_MODEM_RAT_2G   = 0;
   static final int DEV_MODEM_RAT_GMS  = 1;
   static final int DEV_MODEM_RAT_UMTS = 2;
   static final int DEV_MODEM_RAT_LTE  = 3;

   /* hardware state of the sim resource.  if enabled, it can
    * be used by the framework and active calls can be handled
    * on it.  if stanb-by, it can be used by the framework but
    ...
    */
   static final int DEV_SIM_STATE_ENABLED  = 0;
   static final int DEV_SIM_STATE_STANDBY  = 1;
   static final int DEV_SIM_STATE_DISABLED = 2;
   ...
   private void addCanned() {
      ...
      rat.set(DEV_MODEM_RAT_2G);
      rat.set(DEV_MODEM_RAT_GMS);
      rat.set(DEV_MODEM_RAT_UMTS);
    ...
    */
   public TelephonyDevModem getModemFromSim(int simIndex) {
      ...
      if (DBG) Rlog.d(LOG_TAG, "getModemFromSim " + simIndex);
