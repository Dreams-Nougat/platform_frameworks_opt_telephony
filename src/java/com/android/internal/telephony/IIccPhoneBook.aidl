...
interface IIccPhoneBook {
     ...
     * @return List of AdnRecord
     */
    List<AdnRecord> getAdnRecordsInEfUsingSub(long subscription, int efid);
     ...
     * @return true for success
     */
    boolean updateAdnRecordsInEfBySearchUsingSub(long subscription, int efid,
            String oldTag, String oldPhoneNumber,
            String newTag, String newPhoneNumber,
            String pin2);
    /**
     ...
     * @return true for success
     */
    boolean updateAdnRecordsInEfByIndexUsingSub(long subscription, int efid, String newTag,
            String newPhoneNumber, int index,
            String pin2);
     ...
     *            recordSizes[2]  is the number of records in the EF file
     */
    int[] getAdnRecordsSizeUsingSub(long subscription, int efid);
