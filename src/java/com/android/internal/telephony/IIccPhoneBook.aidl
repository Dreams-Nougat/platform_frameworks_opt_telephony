...
interface IIccPhoneBook {
     ...
     * @return List of AdnRecord
     */
    List<AdnRecord> getAdnRecordsInEfUsingSub(int subscription, int efid);
     ...
     * @return true for success
     */
    boolean updateAdnRecordsInEfBySearchUsingSub(int subscription, int efid,
            String oldTag, String oldPhoneNumber,
            String newTag, String newPhoneNumber,
            String pin2);
    /**
     ...
     * @return true for success
     */
    boolean updateAdnRecordsInEfByIndexUsingSub(int subscription, int efid, String newTag,
            String newPhoneNumber, int index,
            String pin2);
     ...
     *            recordSizes[2]  is the number of records in the EF file
     */
    int[] getAdnRecordsSizeUsingSub(int subscription, int efid);
