...
final class GsmServiceStateTracker extends ServiceStateTracker {
    ...
    private boolean isSameNamedOperators(ServiceState s) {
        ...
        boolean equalsOnsl = onsl != null && spn != null && !spn.isEmpty() && spn.equalsIgnoreCase(onsl);
        boolean equalsOnss = onss != null && spn != null && !spn.isEmpty() && spn.equalsIgnoreCase(onss);
