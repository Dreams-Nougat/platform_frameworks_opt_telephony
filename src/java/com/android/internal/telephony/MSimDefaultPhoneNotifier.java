...
public class MSimDefaultPhoneNotifier extends DefaultPhoneNotifier {
    ...
    public void notifySignalStrength(Phone sender) {
        int subscription = sender.getSubscription();
        try {
            mRegistry.notifySignalStrengthOnSubscription(sender.getSignalStrength(), subscription);
        } catch (RemoteException ex) {
            // system process is dead
        }
    }
    ...
    public void notifyMessageWaitingChanged(Phone sender) {
        int subscription = sender.getSubscription();
        try {
            mRegistry.notifyMessageWaitingChangedOnSubscription(
    ...
    public void notifyCallForwardingChanged(Phone sender) {
        int subscription = sender.getSubscription();
        try {
            mRegistry.notifyCallForwardingChangedOnSubscription(
    ...
    public void notifyDataActivity(Phone sender) {
        try {
            mRegistry.notifyDataActivity(convertDataActivityState(
    ...
    public void notifyDataConnectionFailed(Phone sender, String reason, String apnType) {
        int subscription = sender.getSubscription();
        try {
            mRegistry.notifyDataConnectionFailedOnSubscription(reason, apnType, subscription);
    ...
    public void notifyCellLocation(Phone sender) {
        ...
        try {
            mRegistry.notifyCellLocationOnSubscription(data, subscription);
        } catch (RemoteException ex) {
            // system process is dead
        }
    }
    ...
    public void notifyCellInfo(Phone sender, List<CellInfo> cellInfo) {
        int subscription = sender.getSubscription();
        try {
            mRegistry.notifyCellInfoOnSubscription(cellInfo, subscription);
        } catch (RemoteException ex) {
