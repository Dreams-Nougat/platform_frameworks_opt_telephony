...
public final class ImsSMSDispatcher extends SMSDispatcher {
    ...
    public ImsSMSDispatcher(PhoneBase phone, SmsStorageMonitor storageMonitor,
        ...
        phone.mIccRecords.registerForNewSms(this, EVENT_NEW_ICC_SMS, null);
    }
    ...
    protected void updatePhoneObject(PhoneBase phone) {
        ...
        // active phone changed, register
        mPhone.mIccRecords.unregisterForNewSms(this);
        mPhone.mIccRecords.registerForNewSms(this, EVENT_NEW_ICC_SMS, null);
    }
    ...
    public void handleMessage(Message msg) {
        ...
        case EVENT_NEW_ICC_SMS:
            ar = (AsyncResult)msg.obj;
            mGsmDispatcher.dispatchMessage(
                    (com.android.internal.telephony.gsm.SmsMessage)ar.result);
            break;
