...
public abstract class Phone extends Handler implements PhoneInternalInterface {
    ...
    // Keep track of whether or not the phone is in Emergency Callback Mode
    ...
    */
     ...
     * emergency operator.
     *
     * GSM phones do not use this property and should not call this function
     */
