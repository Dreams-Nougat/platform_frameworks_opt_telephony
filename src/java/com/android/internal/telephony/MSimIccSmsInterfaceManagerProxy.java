...
public class MSimIccSmsInterfaceManagerProxy extends ISms.Stub {
    ...
    public boolean
    updateMessageOnIccEfUsingSub(int subscription, String callingPackage, int index, int status, byte[] pdu)
    ...
    public boolean copyMessageToIccEfUsingSub(int subscription, String callingPackage, int status, byte[] pdu,
    ...
    public List<SmsRawData> getAllMessagesFromIccEfUsingSub(int subscription, String callingPackage)
                throws android.os.RemoteException {
        IccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null) {
    ...
    public void sendDataUsingSub(int subscription, String callingPackage, String destAddr, String scAddr, int destPort,
            byte[] data, PendingIntent sentIntent, PendingIntent deliveryIntent) {
        IccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null) {
    ...
    public void sendTextUsingSub(int subscription, String callingPackage, String destAddr, String scAddr,
            String text, PendingIntent sentIntent, PendingIntent deliveryIntent) {
        IccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null) {
    ...
    public void sendTextWithPriority(String destAddr, String scAddr, String text,
        ...
        sendTextWithPriorityUsingSub(getPreferredSmsSubscription(), destAddr, scAddr, text,
            sentIntent, deliveryIntent, priority);
    }

    public void sendTextWithPriorityUsingSub(int subscription, String destAddr, String scAddr, String text,
    ...
    public void sendMultipartTextUsingSub(int subscription, String callingPackage, String destAddr, String scAddr,
            List<String> parts, List<PendingIntent> sentIntents,
    ...
    public boolean enableCellBroadcastRangeUsingSub(int subscription, int startMessageId, int endMessageId)
                throws android.os.RemoteException {
        IccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
    ...
    public boolean disableCellBroadcastRangeUsingSub(int subscription, int startMessageId, int endMessageId)
                throws android.os.RemoteException {
        IccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
    ...
    @Override
    public void setPremiumSmsPermissionUsingSub(int subscription, String packageName, int permission) {
        IccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
    ...
    private IccSmsInterfaceManager getIccSmsInterfaceManager(int subscription) {
        try {
            return (IccSmsInterfaceManager)
                ((PhoneProxy)mPhone[subscription]).getIccSmsInterfaceManager();
