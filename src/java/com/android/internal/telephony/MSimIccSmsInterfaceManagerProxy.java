 ...
 * access Sms in Icc.
 */
public class MSimIccSmsInterfaceManagerProxy extends ISms.Stub {
    ...
    updateMessageOnIccEf(String callingPackage, int index, int status, byte[] pdu) throws android.os.RemoteException {
        return  updateMessageOnIccEfOnSubscription(callingPackage, index, status, pdu, getPreferredSmsSubscription());
    }
    public boolean
    updateMessageOnIccEfOnSubscription(String callingPackage, int index, int status, byte[] pdu, int subscription)
    ...
    public boolean copyMessageToIccEf(String callingPackage, int status, byte[] pdu, byte[] smsc) throws android.os.RemoteException {
        return copyMessageToIccEfOnSubscription(callingPackage, status, pdu,
            smsc, getPreferredSmsSubscription());
    }

    public boolean copyMessageToIccEfOnSubscription(String callingPackage, int status, byte[] pdu,
    ...
    public List<SmsRawData> getAllMessagesFromIccEf(String callingPackage) throws android.os.RemoteException {
        return getAllMessagesFromIccEfOnSubscription(callingPackage, getPreferredSmsSubscription());
    }
    public List<SmsRawData> getAllMessagesFromIccEfOnSubscription(String callingPackage, int subscription)
                throws android.os.RemoteException {
        MSimIccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null) {
    ...
    public void sendData(String callingPackage, String destAddr, String scAddr, int destPort,
         ...
         sendDataOnSubscription(callingPackage, destAddr, scAddr, destPort,
            data, sentIntent, deliveryIntent, getPreferredSmsSubscription());
    }

    public void sendDataOnSubscription(String callingPackage, String destAddr, String scAddr, int destPort,
    ...
    public void sendText(String callingPackage, String destAddr, String scAddr,
        ...
        sendTextOnSubscription(callingPackage, destAddr, scAddr,
            text, sentIntent, deliveryIntent, getPreferredSmsSubscription());
    }

    public void sendTextOnSubscription(String callingPackage, String destAddr, String scAddr,
    ...
    public void sendTextWithPriority(String destAddr, String scAddr, String text,
        ...
        sendTextWithPriorityOnSubscription(destAddr, scAddr, text,
            sentIntent, deliveryIntent, priority, getPreferredSmsSubscription());
    }

    public void sendTextWithPriorityOnSubscription(String destAddr, String scAddr, String text,
    ...
    public void sendMultipartText(String callingPackage, String destAddr, String scAddr,
         ...
         sendMultipartTextOnSubscription(callingPackage, destAddr, scAddr,
            parts, sentIntents, deliveryIntents, getPreferredSmsSubscription());
    }

    public void sendMultipartTextOnSubscription(String callingPackage, String destAddr, String scAddr,
            List<String> parts, List<PendingIntent> sentIntents,
    ...
    public int getPremiumSmsPermission(String packageName) {
        return getPremiumSmsPermissionOnSubscription(packageName, getPreferredSmsSubscription());
    }

    @Override
    public int getPremiumSmsPermissionOnSubscription(String packageName, int subscription) {
        MSimIccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
    ...
    public void setPremiumSmsPermission(String packageName, int permission) {
         setPremiumSmsPermissionOnSubscription(packageName, permission, getPreferredSmsSubscription());
    }

    @Override
    public void setPremiumSmsPermissionOnSubscription(String packageName, int permission, int subscription) {
        MSimIccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
    ...
    public boolean isImsSmsSupported() {
        return isImsSmsSupportedOnSubscription(getPreferredSmsSubscription());
    }

    @Override
    public boolean isImsSmsSupportedOnSubscription(int subscription) {
        MSimIccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
    ...
    public String getImsSmsFormat() {
        return getImsSmsFormatOnSubscription(getPreferredSmsSubscription());
    }

    @Override
    public String getImsSmsFormatOnSubscription(int subscription) {
        MSimIccSmsInterfaceManager iccSmsIntMgr = getIccSmsInterfaceManager(subscription);
        if (iccSmsIntMgr != null ) {
