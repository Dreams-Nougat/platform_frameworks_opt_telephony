...
public class UiccPhoneBookController extends IIccPhoneBook.Stub {
    ...
    /* only one IccPhonBookInterfaceManagerProxy exists */
    ...
    public boolean
    updateAdnRecordsInEfBySearchUsingSub(int subscription, int efid, String oldTag, String oldPhoneNumber,
            String newTag, String newPhoneNumber, String pin2) throws android.os.RemoteException {
    ...
    public boolean
    updateAdnRecordsInEfByIndexUsingSub(int subscription, int efid, String newTag, String newPhoneNumber,
    ...
    public int[]
    getAdnRecordsSizeUsingSub(int subscription, int efid) throws android.os.RemoteException {
        IccPhoneBookInterfaceManagerProxy iccPbkIntMgrProxy =
                             getIccPhoneBookInterfaceManagerProxy(subscription);
        if (iccPbkIntMgrProxy != null) {
    ...
    public List<AdnRecord> getAdnRecordsInEfUsingSub(int subscription, int efid)
