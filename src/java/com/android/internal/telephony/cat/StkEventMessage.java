...
public class StkEventMessage {
    ...
    public StkEventMessage(int event, int sourceId, int destId, byte[] additionalInfo, boolean oneShot ) {
        this.mEvent = event;
    ...
    public StkEventMessage(int event, byte[] additionalInfo, boolean oneShot ) {
        this.mEvent = event;
        this.mAdditionalInfo = additionalInfo;
        this.mOneShot = oneShot;
    }
