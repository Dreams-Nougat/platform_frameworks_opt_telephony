...
class BipCommandParamsFactory extends Handler {
    ...
    private boolean processOpenChannel(CommandDetails cmdDet,
        ...
        if (ctlv != null) {
            indexTransportProtocol = mTlvIndex;
        ...
        if (transportProtocol != null) {
            ...
            if (ctlv != null) {
                if (mTlvIndex < indexTransportProtocol) {
                    ...
                    ctlv = searchForNextTagAndIndex(ComprehensionTlvTag.OTHER_ADDRESS, iter);
                    if (ctlv != null && mTlvIndex > indexTransportProtocol) {
                ...
                } else if (mTlvIndex > indexTransportProtocol) {
                    CatLog.d("[BIP]",
