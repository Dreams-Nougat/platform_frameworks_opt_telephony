...
/**
 * Class that defines BIP constants.
 *
 * {@hide}
 */
public class BipUtils {
    final public static int MAX_APDU_SIZE = 237;
    ...
    final public static int BEARER_TYPE_EUTRAN = 0x0B;
    ...
    //network failure or user cancellation
