...
/**
 * Class that implements Other Address ComprehensionTlvTag.
 *
 * {@hide}
 */
public class OtherAddress {
     ...
     * @param rawData raw data of address
     * @param index index byte in raw data
     * @throws UnknownHostException if format error
     */
