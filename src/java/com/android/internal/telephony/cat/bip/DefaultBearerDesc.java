...
/**
 * Class that implements Default bearer description.
 *
 * {@hide}
 */
public class DefaultBearerDesc extends BearerDesc {
    ...
    public DefaultBearerDesc() {
        bearerType = BipUtils.BEARER_TYPE_DEFAULT;
    }
    ...
    public static final Parcelable.Creator<DefaultBearerDesc> CREATOR =
        new Parcelable.Creator<DefaultBearerDesc>() {
