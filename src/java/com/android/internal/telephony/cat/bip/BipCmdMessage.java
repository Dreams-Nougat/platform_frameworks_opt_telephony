...
public class BipCmdMessage implements Parcelable {
    ...
    BipCmdMessage(CommandParams cmdParams) {
        ...
        case GET_CHANNEL_STATUS:
            mTextMsg = ((GetChannelStatusParams) cmdParams).mTextMsg;
            break;
        case OPEN_CHANNEL:
            ...
            mTextMsg = ((OpenChannelParams) cmdParams).mTextMsg;
            ...
            break;
        case CLOSE_CHANNEL:
            mTextMsg = ((CloseChannelParams) cmdParams).mTextMsg;
            mCloseCid = ((CloseChannelParams) cmdParams).mCloseCid;
            mCloseBackToTcpListen = ((CloseChannelParams) cmdParams).mBackToTcpListen;
            break;
        case RECEIVE_DATA:
            mTextMsg = ((ReceiveDataParams) cmdParams).mTextMsg;
            mChannelDataLength = ((ReceiveDataParams) cmdParams).mChannelDataLength;
            mReceiveDataCid = ((ReceiveDataParams) cmdParams).mReceiveDataCid;
            break;
        case SEND_DATA:
            mTextMsg = ((SendDataParams) cmdParams).mTextMsg;
            mChannelData = ((SendDataParams) cmdParams).mChannelData;
