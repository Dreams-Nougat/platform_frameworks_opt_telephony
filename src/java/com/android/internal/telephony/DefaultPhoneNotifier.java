...
public class DefaultPhoneNotifier implements PhoneNotifier {
    ...
    @Override
    public void notifyDataActivationStateChanged(Phone sender, String activationState) {
        try {
            mRegistry.notifyDataActivationStateChangedForPhoneId(sender.getPhoneId(),
    ...
    @Override
    public void notifyVoiceActivationStateChanged(Phone sender, String activationState) {
        try {
            mRegistry.notifyVoiceActivationStateChangedForPhoneId(sender.getPhoneId(),
                    sender.getSubId(), activationState);
        } catch (RemoteException ex) {
            // system process is dead
        }
