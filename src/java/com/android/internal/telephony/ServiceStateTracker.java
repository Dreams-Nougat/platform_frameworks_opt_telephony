...
public abstract class ServiceStateTracker extends Handler {
    ...
    */
        ...
        try {
            ...
            try {
                ...
                if (getAutoTime()) {
                    ...
                    int nitzUpdateSpacing = Settings.Global.getInt(getPhone().getContext().getContentResolver(),
                            Settings.Global.NITZ_UPDATE_SPACING, mNitzUpdateSpacing);
                    int nitzUpdateDiff = Settings.Global.getInt(getPhone().getContext().getContentResolver(),
    ...
    protected void setAndBroadcastNetworkSetTimeZone(String zoneId) {
        ...
        AlarmManager alarm =
            (AlarmManager) getPhone().getContext().getSystemService(Context.ALARM_SERVICE);
