 ...
 * multiple instances of icc objects. This class implements the IccCard interface to
 * expose the current (based on voice radio technology) application on the uicc card,
 * so that external apps wont break.
 */
