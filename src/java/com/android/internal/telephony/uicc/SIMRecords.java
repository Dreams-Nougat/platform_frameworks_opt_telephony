    ...
    public void handleMessage(Message msg) {
        ...
        try { switch (msg.what) {
            ...
            case EVENT_GET_PLMN_W_ACT_DONE:
                ...
                if (ar.exception != null) {
                    loge("Exception getting User PLMN with Access Tech Records: " + ar.exception);
                    break;
                } else {
            ...
            case EVENT_GET_OPLMN_W_ACT_DONE:
                ...
                if (ar.exception != null) {
                    loge("Exception getting Operator PLMN with Access Tech Records: "
                            + ar.exception);
                    break;
                } else {
                    log("Received a PlmnActRecord, raw=" + IccUtils.bytesToHexString(data));
            ...
            case EVENT_GET_HPLMN_W_ACT_DONE:
                ...
                if (ar.exception != null) {
                    loge("Exception getting Home PLMN with Access Tech Records: " + ar.exception);
                    break;
                } else {
                    log("Received a PlmnActRecord, raw=" + IccUtils.bytesToHexString(data));
