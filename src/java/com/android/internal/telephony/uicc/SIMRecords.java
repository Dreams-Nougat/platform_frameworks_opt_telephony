...
public class SIMRecords extends IccRecords {
    ...
    public void handleMessage(Message msg) {
        ...
        try { switch (msg.what) {
            ...
            case EVENT_GET_EHPLMN_DONE:
                ...
                parseBcdPlmnList(data, mEhplmns, "Equivalent Home");
                break;
            ...
            case EVENT_GET_FPLMN_DONE:
                ...
                parseBcdPlmnList(data, mFplmns, "Forbidden");
                break;
     ...
     */
    private void
    parseBcdPlmnList(byte[] data, String[] dest, String description) {
        ...
        dest = new String[numPlmns];
        for(int i = 0; i < numPlmns; i++) {
            dest[i] = IccUtils.bcdPlmnToString(data, i*3);
        }
        log(description + " PLMNs: " + Arrays.toString(dest));
    }
    /**
