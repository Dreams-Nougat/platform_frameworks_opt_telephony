    ...
    private void handleRefresh(IccRefreshResponse refreshResponse){
        ...
        switch (refreshResponse.refreshResult) {
            case IccRefreshResponse.REFRESH_RESULT_FILE_UPDATE:
                if (DBG) log("handleRefresh with FILE_UPDATED");
                handleFileUpdate(refreshResponse.efId);
                break;
            case IccRefreshResponse.REFRESH_RESULT_INIT:
                if (DBG) log("handleRefresh with REFRESH_INIT");
            ...
            case IccRefreshResponse.REFRESH_RESULT_RESET:
                if (DBG) log("handleRefresh with REFRESH_RESET");
                ...
                */
                ...
                mAdnCache.reset();
                //We will re-fetch the records when the app
                // goes back to the ready state. Nothing more to do here.
                break;
            default:
