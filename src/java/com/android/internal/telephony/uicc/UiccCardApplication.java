...
public class UiccCardApplication {
    ...
    private boolean       mIccLockEnabled = false;;
        ...
        if(ints.length != 0) {
            ...
            switch (mPin1State) {
                case PINSTATE_DISABLED:
                    if (mIccLockEnabled) {
                        // STOPSHIP This can't be. Programming error suspected
                        // We really need to use information from GET_SIM_STATUS though since it
                        // has more information (specific state: pin, puk, permanently blocked)
    ...
    public boolean getIccLockEnabled() {
        ...
        /* STOPSHIP remove line above and use code below once RIL
         * correctly notifies pin1 state
