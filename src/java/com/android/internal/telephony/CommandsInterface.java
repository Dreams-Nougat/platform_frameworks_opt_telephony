...
//  static final int CF_ACTION_UNUSED           = 2;
     ...
     *
     * Input parameters equivalent to 27.007 AT+CCHO command.
     *
     ...
     *
     * Input parameters equivalent to 27.007 AT+CCHC command.
     *
     ...
     *
     * Input parameters equivalent to 27.007 AT+CGLA command.
     *
     ...
     *
     * Input parameters equivalent to 27.007 AT+CSIM command.
     *
     * @param cla Class of the APDU command.
     * @param instruction Instruction of the APDU command.
     * @param p1 P1 value of the APDU command.
