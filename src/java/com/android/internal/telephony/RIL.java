...
public final class RIL extends BaseCommands implements CommandsInterface {
     ...
     * is plugged.
     * @param forceUpdateForOff. If it is true, update screen state OFF without compare to oldState.
     */
    private void updateScreenState(boolean forceUpdateForOff) {
        ...
        if (mRadioScreenState != oldState || (forceUpdateForOff && !mIsDevicePlugged)) {
            if (RILJ_LOGV) {
...
*/
        ...
        switch(response) {
            ...
            case RIL_UNSOL_RIL_CONNECTED: {
                ...
                // state cannot be sent to modem. Resend the display state OFF here so that modem has
