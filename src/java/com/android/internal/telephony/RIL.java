...
public final class RIL extends BaseCommands implements CommandsInterface {
    ...
    class RadioResponse extends IRadioResponse.Stub {
        public void iccCardStatusResponse(RadioResponseInfo responseInfo, CardStatus cardStatus) {
            Log.d(RILJ_LOG_TAG, "responseGetSimStatus: serial " + responseInfo.serial +
                    " cardStatus.cardState " + cardStatus.cardState);
            RILRequest rr = findAndRemoveRequestFromList(responseInfo.serial);

            Object ret = null;
            if (rr.mResult != null) {
                Log.d(RILJ_LOG_TAG, "responseGetSimStatus: rr.mResult != null");
        ...
        public void unsolRadioStateChanged(int radioState) {
            Log.d(RILJ_LOG_TAG, "unsolRadioStateChanged");
    ...
    private IRadio getRadioProxy() {
        ...
        try {
            radioProxy = IRadio.getService("ril_service1");
            if (radioProxy != null) {
                ...
                radioProxy.setResponseFunctions(mInstanceId, mRadioResponse, null);
