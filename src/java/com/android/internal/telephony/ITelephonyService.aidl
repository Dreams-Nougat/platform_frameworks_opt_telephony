...
interface ITelephonyService {
    ...
    void registerCallback(ITelephonyServiceCallBack cb);

    void unregisterCallback(ITelephonyServiceCallBack cb);
    ...
    void requestForegroundCallerInfo(ITelephonyServiceCallBack cb);

    void requestBackgroundCallerInfo(ITelephonyServiceCallBack cb);

    void requestConferenceCallersInfo(ITelephonyServiceCallBack cb);
}
