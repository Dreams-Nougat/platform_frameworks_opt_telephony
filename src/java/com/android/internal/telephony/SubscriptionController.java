 ...
 */
public class SubscriptionController extends Handler {
    ...
    /**
     * Class to maintain the current subscription info in SubscriptionController.
     */
    ...
    //***** Class Variables
    private static SubscriptionController sSubscriptionController;
    ...
    private CardSubscriptionController mCardSubMgr;
    ...
    /**
     * Get singleton instance of SubscriptionController.
     * @param context
     * @param uiccMgr
     * @param ci
     * @return
            ...
            MSimUiccController uiccController, CommandsInterface[] ci)
    {
        ...
        if (sSubscriptionController == null) {
            sSubscriptionController = new SubscriptionController(context, uiccController, ci);
        }
     ...
     * @param ci
     */
    private SubscriptionController(Context context, MSimUiccController uiccController,
