...
public class SubInfoRecordUpdater extends Handler {
    ...
    public SubInfoRecordUpdater() {
        ...
        for (int i = 0; i < PROJECT_SIM_NUM; i++) {
            sPhone[i] = ((PhoneProxy)(PhoneFactory.getPhone(i))).getActivePhone();
    ...
    private final BroadcastReceiver sReceiver = new  BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(TelephonyIntents.ACTION_SIM_STATE_CHANGED)) {
                ...
                simId = intent.getIntExtra(PhoneConstants.SLOT_KEY, 0);
    ...
    public void handleMessage(Message msg) {
        ...
        int msgNum = msg.what;
        int simId; 
        for (simId = PhoneConstants.SUB1; simId <= PhoneConstants.SUB3; simId++) {
