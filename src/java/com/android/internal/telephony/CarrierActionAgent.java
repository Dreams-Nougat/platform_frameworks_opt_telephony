...
/**
 * CAA paired with CarrierSignalAgent {@link com.android.internal.telephony.CarrierSignalAgent},
 * serves as an agent to dispatch carrier actions from carrier apps to different telephony modules,
 * {@link android.telephony.TelephonyManager#carrierActionSetRadioEnabled(int, boolean)}for example.
 *
...
public class CarrierActionAgent extends Handler {
    ...
    /** carrier actions */
    private Boolean mCarrierActionOnMeteredApnEnabled = null;
    private Boolean mCarrierActionOnRadioEnabled = null;
    ...
    public void unregisterForCarrierAction(Handler h, int action) {
        ...
        if (list == null) return;
        synchronized (mLock) {
            mMeteredApnEnableRegistrants.remove(h);
        }
    }
